    ...
    <html lang="en" data-theme='light'>
      ...
      <body className={`${inter.className} bg-white`}>
        <div className="flex flex-row mx-auto gap-3 md:gap-6 font-mono text-xs md:text-base font-bold p-3 w-full mt-5 sticky top-0 z-20 bg-white">
          ...
          <a href="/#other-stuff" className="cursor-pointer hover:scale-110 text-center">Other Stuff</a>
          <a href="/thoughts" className="cursor-pointer mr-auto hover:scale-110 text-center">Thoughts</a>
        </div>
        {children}
      </body>
    </html>

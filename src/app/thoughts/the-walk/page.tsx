...
const Walk = () => {
  return (
    <main className="flex min-h-screen flex-col md:w-[66%] mx-auto p-6 lg:pb-12 lg:px-24 lg:pt-16 font-mono bg-white">
      ...
      <p className="mb-4 text-lg font-bold">TL;DR
</p>
      <div className=" flex flex-col gap-2 md:flex-row">
        <div className="flex flex-col md:w-[60%]">
          ...
          <p>
            ...
            Spring Leaf Prata, West Coast (Dinner) ={">"}Commenwealth ={">"} Clarke Quay ={">"} East Coast Park ={">"} Changi City Point
          </p>
          <p className="mt-4">
            <span className="font-semibold ">What we gained:</span> Sore legs,
            blistered feet, and <span className="font-bold ">THE ULTIMATE BRAGGING RIGHTS FOR WALKING ACROSS AN ENTIRE COUNTRY.</span>
          </p>
        </div>
        <div>
          <Image
